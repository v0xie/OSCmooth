...
namespace OSCTools.OSCmooth.Animation
{
    public class OSCmoothAnimationHandler
    {
        ...
        public void CreateSmoothAnimationLayer()
        {
            ...
            animLayer = AnimUtil.CreateAnimLayerInController($"{CVRProps.CVRPrefix}OSCmooth_Smoothing_Gen_", animatorController);
            ...
            var isLocalName = $"#IsLocal";
            ParameterUtil.CheckAndCreateParameter(isLocalName, animatorController, AnimatorControllerParameterType.Bool);

            toRemoteState.AddCondition(AnimatorConditionMode.IfNot, 0, isLocalName);
            toLocalState.AddCondition(AnimatorConditionMode.If, 0, isLocalName);
            ...
            ParameterUtil.CheckAndCreateParameter($"{CVRProps.CVRPrefix}1Set", animatorController, AnimatorControllerParameterType.Float, 1);
            ...
            foreach (OSCmoothParameter p in parameters)
            {
                ...
                {
                    directBlendParameter = $"{CVRProps.CVRPrefix}1Set",
